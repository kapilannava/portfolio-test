  ...
  <Row>
    ...
    <Col sm={9}>
      <Tab.Content>
        ...
        <li>Troubleshoot and debug issues on Intelex web properties</li>
...
<li>Participated in regularly scheduled stand-ups with the project team to understand requirements, suggest product improvements, explain code design, provide estimates, describe work 
        ...
        Freelance
            ...
            <li>Designs creative, front-end digital experiences, and translates designs into working responsive 
                front-end code, and measurable business results (e.g. lead generation, 
                conversion to purchase, or persuasion)</li>
